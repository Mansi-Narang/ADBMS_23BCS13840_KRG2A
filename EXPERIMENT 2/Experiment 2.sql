-- HEADING: ORGANIZATIONAL HIERARCHY EXPLORER (MEDIUM)
...
SELECT A.EmpName AS [Employee Name], A.Department[Department], B.EmpName[Manager Name], B.Department [Manager Department]
FROM Employee AS A LEFT OUTER JOIN Employee AS B
ON
A.ManagerID = B.EmpID;
